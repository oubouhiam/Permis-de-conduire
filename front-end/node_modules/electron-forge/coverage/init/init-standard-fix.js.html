...
<html lang="en">
<head>
    <title>Code coverage report for init/init-standard-fix.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">init</a> init-standard-fix.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    child.on('exit', (code) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (code === 0) resolve();
      <span class="missing-if-branch" title="if path not taken" >I</span>if (code !== 0) <span class="cstat-no" title="statement not covered" >reject(new Error(`Failed to fix JS to standard style (${code})`));</span>
    });
  });
&nbsp;
