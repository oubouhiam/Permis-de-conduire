...
<html lang="en">
<head>
    <title>Code coverage report for api/install.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> install.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    releases = releases.filter(release =&gt; !release.prerelease || <span class="branch-1 cbranch-no" title="branch not covered" >prerelease)</span>;
&nbsp;
...
&nbsp;
  console.info(`Found latest release${prerelease ? <span class="branch-0 cbranch-no" title="branch not covered" >' (including prereleases)' </span>: ''}: ${latestRelease.tag_name.cyan}`);
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!await fs.exists(fullFilePath) || <span class="branch-1 cbranch-no" title="branch not covered" >(await fs.stat(fullFilePath)).size !== targetAsset.size)</span> {
