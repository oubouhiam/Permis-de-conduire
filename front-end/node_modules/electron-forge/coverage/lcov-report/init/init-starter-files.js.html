...
<html lang="en">
<head>
    <title>Code coverage report for init/init-starter-files.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">init</a> init-starter-files.js
    </h1>
    <div class='clearfix'>
...
export const copy = (source, target) =&gt;
  new Promise((resolve, reject) =&gt; {
    ...
    let rd;
    let wr;
    const rejectCleanup = <span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
<span class="cstat-no" title="statement not covered" >      rd.destroy();</span>
<span class="cstat-no" title="statement not covered" >      wr.end();</span>
