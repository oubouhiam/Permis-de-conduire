...
&nbsp;
  ...
  const appName = forgeConfig.electronPackagerConfig.name || packageJSON.productName || <span class="branch-2 cbranch-no" title="branch not covered" >packageJSON.name;</span>
  const outputs = [];
&nbsp;
