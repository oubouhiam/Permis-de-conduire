...
<html lang="en">
<head>
    <title>Code coverage report for util/install-dependencies.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> install-dependencies.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">39x</span>
<span class="cline-any cline-yes">39x</span>
<span class="cline-any cline-yes">1362x</span>
...
export default (dir, deps, areDev = false, exact = false) =&gt; {
  ...
  return new Promise((resolve, reject) =&gt; {
    ...
    const child = yarnOrNPMSpawn(cmd, {
      cwd: dir,
      stdio: config.get('verbose') ? <span class="branch-0 cbranch-no" title="branch not covered" >'inherit' </span>: 'pipe',
    });
    let output = '';
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!config.get('verbose')) {
