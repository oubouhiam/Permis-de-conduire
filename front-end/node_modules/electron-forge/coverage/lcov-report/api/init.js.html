...
<html lang="en">
<head>
    <title>Code coverage report for api/init.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> init.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  if (!template) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!['airbnb', 'standard'].includes(lintstyle)) {
<span class="cstat-no" title="statement not covered" >      d(`Unrecognized lintstyle argument: '${lintstyle}' -- defaulting to 'airbnb'`);</span>
<span class="cstat-no" title="statement not covered" >      lintstyle = 'airbnb';</span>
    }
  }
&nbsp;
