...
<html lang="en">
<head>
    <title>Code coverage report for util/require-search.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">util</a> require-search.js
    </h1>
    <div class='clearfix'>
...
export default (relativeTo, paths) =&gt; {
  ...
  for (const testPath of testPaths) {
    try {
      ...
      return typeof result === 'object' &amp;&amp; result &amp;&amp; result.default ? result.default : <span class="branch-1 cbranch-no" title="branch not covered" >result;</span>
    } catch (err) {
      // Ignore the error
    }
  }
