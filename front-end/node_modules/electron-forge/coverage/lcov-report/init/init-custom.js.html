...
<html lang="en">
<head>
    <title>Code coverage report for init/init-custom.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">init</a> init-custom.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        d('using local template');</span>
      } catch (err2) {
...
&nbsp;
  await asyncOra('Installing Template Dependencies', async () =&gt; {
    ...
    await installDepList(dir, templateModule.dependencies || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
    d('installing devDependencies');
    await installDepList(dir, templateModule.devDependencies || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> true);
  });
&nbsp;
  await asyncOra('Copying Template Files', async () =&gt; {
    const templateDirectory = templateModule.templateDirectory;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (templateDirectory) {
      const tmplPath = templateDirectory;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!path.isAbsolute(templateDirectory)) {
<span class="cstat-no" title="statement not covered" >        throw `Custom template path needs to be absolute, this is an issue with "electron-forge-template-${template}"`;</span>
      }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof templateModule.postCopy === 'function') {
